      ...
      <main>
        ...
        <div id="page-body">
          <section>
            ...
            <p>
              <Trans>
                ...
                <abbr title="Application Programming Interface">API</abbr>, is a
                set of routines, protocols and tools for building software. Many
          ...
          <section>
            ...
            <p>
              <Trans>
                You can choose to access the granular data that you need. You
                will benefit from the ability to extract data data that is
