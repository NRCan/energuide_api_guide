module.exports = {
  ...
  m: {
    ...
    'Search by the file <0>ID</0> on your Energuide evaluation.':
      'Search by the file <0>ID</0> on your Energuide evaluation.',
    'No results found': 'Aucun r\xE9sultat',
    Filters: 'Filters',
    ...
    'How can I use the EnerGuide API?':
      "Comment puis-je utiliser l'API EnerGuide?",
    ...
    'The EnerGuide API allows you to access the housing data provided by Natural Resources Canada. You will have open access the data, and will be able to query to an individual dwelling.':
      "L'API \xC9nerGuide vous permet d'acc\xE9der aux donn\xE9es sur le logement fournies par Ressources naturelles Canada. Vous aurez un acc\xE8s libre aux donn\xE9es, et pourrez interroger un logement individuel.",
    ...
    'An <0>Application Programming Interface</0>, or<1>API</1>, is a set of routines, protocols and tools for building software. Many applications can talk to each other and deliver a response.':
      "Une interface de programmation d'application, ou API, est un ensemble de routines, de protocoles et d'outils pour la construction de logiciels.\xA0De nombreuses applications peuvent se parler et fournir une r\xE9ponse.",
