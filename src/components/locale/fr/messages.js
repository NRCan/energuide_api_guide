module.exports = {
  ...
  m: {
    ...
    'Search for another file <0>ID</0>':
      'Rechercher un autre fichier <0> ID </ 0>',
    results: 'r\xE9sultats',
    'Search again by location': 'Rechercher \xE0 nouveau par emplacement',
    'To test the API, you are able to search by Location or File <0>ID</0>.':
      "Pour tester l'API, vous pouvez effectuer une recherche par emplacement ou par fichier <0> ID </ 0>.",
    'Search by Location or File <0>ID</0>':
      'Recherche par emplacement ou fichier <0> ID </ 0>',
    Alpha: 'Alpha',
    ...
    'Access the API': "Acc\xE9der \xE0 l'API",
    'An <0>Application Programming Interface</0>, or<1>API</1>, is a set of routines, protocols and tools for building software. Many applications can talk to each other and deliver a response.':
      "Une <0> Application Programming Interface </ 0>, ou <1> API </ 1>, est un ensemble de routines, de protocoles et d'outils pour cr\xE9er des logiciels. De nombreuses applications peuvent se parler et fournir une r\xE9ponse.",
    'View open data': 'Afficher les donn\xE9es ouvertes',
    'The EnerGuide API will help make energy consumption data accessible for everyone.':
      "L'API \xC9nerGuide aidera \xE0 rendre les donn\xE9es sur la consommation d'\xE9nergie accessibles \xE0 tous.",
    'You can choose to access the granular data that you need. You will benefit from the ability to extract data data that is specific to your needs.':
      "Vous pouvez choisir d'acc\xE9der aux donn\xE9es granulaires dont vous avez besoin. Vous b\xE9n\xE9ficierez de la capacit\xE9 d'extraire des donn\xE9es de donn\xE9es sp\xE9cifiques \xE0 vos besoins.",
    'Developers and data analysts can allow users to query specific information from large data sets. They set the rules that will guide the user to what they need.':
      "Les d\xE9veloppeurs et les analystes de donn\xE9es peuvent permettre aux utilisateurs d'interroger des informations sp\xE9cifiques \xE0 partir de grands ensembles de donn\xE9es. Ils d\xE9finissent les r\xE8gles qui guideront l'utilisateur \xE0 ce dont ils ont besoin.",
    'Read the documentation': 'Lire la documentation',
    'Search by': 'Recherch\xE9 par',
    'Search by Location': 'Recherche par lieu',
    'Search by the type of energy source. Choose all of the parameters that apply.':
      "Recherche par type de source d'\xE9nergie. Choisissez tous les param\xE8tres qui s'appliquent.",
    'An <0>Application Programming Interface</0>Application Programming Interface, or<1>API</1>, is a set of routines, protocols and tools for building software. Many applications can talk to each other and deliver a response.':
      "Une <0> interface de programmation d'application </ 0> Application Programming Interface, ou <1> API </ 1>, est un ensemble de routines, de protocoles et d'outils pour la construction de logiciels. De nombreuses applications peuvent se parler et fournir une r\xE9ponse.",
    HOME: 'Home',
  },
}
