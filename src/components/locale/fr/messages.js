module.exports = {
  ...
  m: {
    ...
    'This is a demonstration of how the API could be used.':
      "Ceci est une d\xE9monstration de la fa\xE7on dont l'API pourrait \xEAtre utilis\xE9e",
    'Help us improve this internal service, email your feedback':
      'Aidez-nous \xE0 am\xE9liorer ce service interne, envoyez-nous vos commentaires',
    ...
    'To test the API, you are able to search by Location or File <0>ID</0>.':
      "Pour tester l'API, vous pouvez effectuer une recherche par emplacement ou par fichier ID.",
    'Search by Location or File <0>ID</0>':
      'Recherche par emplacement ou fichier ID',
    Location: 'Location',
